...
public class ItemTitleBinder extends ItemViewBinder<ModelBean, ItemTitleBinder.MHolder> {


    @NonNull
    @Override
    protected MHolder onCreateViewHolder(@NonNull LayoutInflater inflater, @NonNull ViewGroup parent) {
        return new MHolder(inflater.inflate(R.layout.title_layout, parent, false));
    }

    @Override
    protected void onBindViewHolder(@NonNull MHolder holder, @NonNull ModelBean item) {
        holder.mNameView.setText("title"+item.getAge());
    }
    ...
    public class MHolder extends RecyclerView.ViewHolder {
        ...
        public MHolder(@NonNull View itemView) {
            super(itemView);
            mNameView = itemView.findViewById(R.id.tv_title);
